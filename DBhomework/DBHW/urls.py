...
urlpatterns = [
    ...
    re_path(r'^lineitemview-(?P<nid>\d+)/', Lineitem_view, name='lineitemview'),
    ...
    re_path(r'^partdelete-(?P<nid>\d+)/', Nation_delete, name='partdelete'),
    re_path(r'^partsupplist/', Partsupp_list, name='partsupplist'),
    re_path(r'^partsuppedit-(?P<nid>\d+)/', Partsupp_Edit, name='partsuppedit'),
    re_path(r'^partsuppadd/', Partsupp_Add, name='partsuppadd'),
    re_path(r'^partsuppview-(?P<nid>\d+)/', Partsupp_view, name='partsuppview'),
    re_path(r'^partsuppdelete-(?P<nid>\d+)/',Partsupp_delete, name='partsuppdelete'),
